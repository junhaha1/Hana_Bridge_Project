...
const SettingModal = ({onClose}) => {
  ...
  return (
    <div className={upDiv +  "  p-2"}>
      <div className={`${settingDiv} ${scrollStyle}`}>
        ...
        <div className='flex flex-col gap-2 p-2'>
          {!isAddPrompt && !isUpdatePrompt &&(
            <>
            <p className="mb-3 text-sm"><span className="text-yellow-400 font-semibold">Tip  </span>프롬프트란? <br />AI에게 명확한 지시를 내리는 입력값으로 좋은 답변을 받는데 기여할 수 <br/>있습니다.  </p>
            <div 
            ...
            <div 
              className={`${promptButton} ${userPromptList.length === 0 ? 'opacity-50 cursor-not-allowed' : ''}`}
              onClick={() => {
