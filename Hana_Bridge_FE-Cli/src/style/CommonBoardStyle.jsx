...
/*글 작성 버튼 */
export const addButton = "bg-white hover:!bg-[#C5BCFF] hover:text-black px-3 rounded-md text-sm font-semibold max-md:text-xs text-indigo-900 transition-colors duration-300 whitespace-nowrap";
